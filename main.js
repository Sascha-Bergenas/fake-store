...
import { productCard, renderSearched, renderSort } from "./uiComponent.js";
...
document.querySelector("#price-falling").addEventListener("click", async () => {
  if (productArr.length === 0) {
    const products = await getData();
    productCard(products);
  } else {
    renderSort(productArr);
  }
});
